...
const ButtonsChecked = () => {
    ...
    return (
        <>
            ...
            <Layout gridTemplateColumns="repeat(3, min-content)" gap={4}>
                <Button
                ...
                />
                <Button
                    onClick={() => setChecked((prev) => ({ ...prev, 4: !prev[4] }))}
                    text="Button"
                    iconLeft={svgFilter}
                    view={checked[4] ? 'checked' : undefined}
                />
                <Button
                    onClick={() => setChecked((prev) => ({ ...prev, 5: !prev[5] }))}
                    text="Button"
                    iconRight={svgPlus}
                    view={checked[5] ? 'checked' : undefined}
                />
                <Button
                    onClick={() => setChecked((prev) => ({ ...prev, 6: !prev[6] }))}
                    text="Button"
                    iconLeft={svgPlusCircle}
                    view={checked[6] ? 'checked' : undefined}
                    iconRight={svgPlusCircle}
                />
            </Layout>
        </>
